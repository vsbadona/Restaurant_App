...
class Atri:
	...
	def Data(self, new_state):
		...
		global default_state
		self._Data = Flex(new_state, default_state["Data"])
	...
	def Button(self, new_state):
		...
		global default_state
		self._Button = Div(new_state, default_state["Button"])
